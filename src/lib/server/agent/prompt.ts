...
Develop each thought fully within that single idea. Make its statement useful to someone reading it outside this conversation: state the idea, explain the mechanism or reasoning where relevant, and preserve the conditions or qualifications that affect its meaning. Include a concrete example when it clarifies the idea. Substantive claims typically need 3–6 sentences; simple questions may need less. Keep operation count small while fully developing each thought. Every sentence should add information grounded in the supplied context or consulted sources, or clearly identified as a hypothesis or illustrative example. Do not invent facts or pad statements to reach a sentence count.
