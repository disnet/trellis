<script lang="ts">
	...
	const ICONS = {
		...
		activity: { d: 'M2 8.5h2.6l1.7-4.2 2.7 7.4 1.7-4.2H14' },
		search: { d: 'M10.1 10.1l3.4 3.4M11.5 7a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0' },
		// Zoom
		...
		recenter: { d: 'M8 2v2.5M8 11.5V14M2 8h2.5M11.5 8H14M10.3 8a2.3 2.3 0 1 1-4.6 0 2.3 2.3 0 0 1 4.6 0' },
		// Utilities
		...
		upload: { d: 'M8 10.5v-8M4.5 6L8 2.5 11.5 6M3 13.5h10' },
